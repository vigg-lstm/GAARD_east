...
randomisations = pd.read_csv("../phenotype_randomisations_tanzania.csv", sep="\t")
...
print("Downloading SNP data for Malawi as outgroup")
stdout.flush()
outgroup_query=f"country == 'Malawi' & year == 2015 & taxon == '{spp}'"
...
print("Identifying non-segregating alleles in Malawi")
stdout.flush()
