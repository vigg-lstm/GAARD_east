...
load('~/data/ML/GAARD_SNP/filtered_snp_tables/filtered_snp_tables_tanzania.Rdata')
...
sib.groups.fn <- '../../NGSrelate/full_relatedness_tanzania/sib_group_table.csv'
...
phenotype.filename <- '../phenotype_randomisations_tanzania.csv'
